...
- [x] 1.2 添加通过 `openspec list --specs` 列出规范的支持，保持 `--changes` 为默认
- [x] 1.3 更新命令描述和 `--help` 输出，强调动词-名词模式
...
- [x] 2.3 两种模式共享输出结构；保留当前文本表格；确保未来 JSON 对等
