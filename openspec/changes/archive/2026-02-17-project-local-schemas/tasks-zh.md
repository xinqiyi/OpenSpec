...
- [x] 2.3 更新 `listSchemas(projectRoot?)` 以包含项目本地模式
- [x] 2.4 更新 `listSchemasWithInfo(projectRoot?)` 以包含 `source: 'project'` 的项目模式
