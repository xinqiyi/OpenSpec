...
- [x] 1.3 添加带有描述"管理工作流架构"的 schema 命令组
...
- [x] 5.11 添加带有 `--description` 和 `--artifacts` 标志的非交互模式
...
- [x] 6.5 使用 `@inquirer/prompts` 模拟测试交互模式
